...
2.	Directory Structure
    SDK-gcc/
    ├── bin/                         Directory storing the executable binary file. The shell script deletes this directory before compilation and then creates it again. Therefore, script execution is not affected by this directory. 
    ├── build/                       Build directory. The shell script deletes this directory before compilation and then creates it again. Therefore, script execution is not affected by this directory. 
    ├── cdn/                         Code directory.
    ...
    │     │     ├── lib_record.h     Header file that records the output results to the buffer, which cannot be modified. 
